...
public class Options implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", optionSiteTitle=").append(optionSiteTitle);
        sb.append(", optionSiteDescrption=").append(optionSiteDescrption);
        sb.append(", optionMetaDescrption=").append(optionMetaDescrption);
        sb.append(", optionMetaKeyword=").append(optionMetaKeyword);
        sb.append(", optionAboutsiteAvatar=").append(optionAboutsiteAvatar);
        sb.append(", optionAboutsiteTitle=").append(optionAboutsiteTitle);
        sb.append(", optionAboutsiteContent=").append(optionAboutsiteContent);
        sb.append(", optionAboutsiteWechat=").append(optionAboutsiteWechat);
        sb.append(", optionAboutsiteQq=").append(optionAboutsiteQq);
        sb.append(", optionAboutsiteGithub=").append(optionAboutsiteGithub);
        sb.append(", optionAboutsiteWeibo=").append(optionAboutsiteWeibo);
        sb.append(", optionTongji=").append(optionTongji);
        sb.append(", optionStatus=").append(optionStatus);
